...
const Home = () => {
    ...
    chargersQuery.find().then((chargeResult) => {
      ...
      fetch(`${process.env.REACT_APP_OCPP_BASE_URL}/active_clients`)
        ...
        .then((res: any) => {
          ...
          setChargerTypeData([
            { name: "AC 3.3kW", value: count1, color: "#5185EC" },
            { name: "AC 7.2kW", value: count2, color: "#58A55C" },

            { name: "AC 11kW", value: count4, color: "#5185EC" },
            { name: "DC 15kW", value: count4, color: "#5185EC" },
            { name: "AC 22kW", value: count5, color: "#F1BE42" },
            { name: "DC 25kW", value: count6, color: "#9158A5" },
            { name: "DC 30kW", value: count7, color: "#FF33E3" },
  ...
  useEffect(() => {
    setChargerStatus([
      { name: "Available", value: piChartData.available, color: "#5185EC" },
      { name: "Charging", value: piChartData.charging, color: "#58A55C" },
      { name: "Out of Order", value: 0, color: "#D85140" },
      { name: "Offline", value: piChartData.offline, color: "#F1BE42" },
      { name: "Scheduled", value: 0, color: "#9158A5" },
    ]);
    ...
    <div className="homeContainer">
      ...
      <Grid container>
        ...
        <Grid item lg={3.5} md={5} xs={12}>
          <Warnings data={alertData} />

          <XChart type="Charger Status" data={chargerStatus} />
          <XChart
            type="Charger Type"
